...
class LiveCodeRunner {
    constructor() {
        ...
        this.client = null;
        this.view = new live_code_runner_view_1.LiveCodeRunnerView();
        this._exec_starts = 0;
        this._config = null;
    ...
    ensureClient() {
        if (this._config === null) {
            ...
            this.clientConfig = new ai.backend.ClientConfig(this._config.get('accessKey'), this._config.get('secretKey'), this._config.get('endpoint'));
            let pkgVersion = '2.1.0'; // TODO: read from package.json
            this.client = new ai.backend.Client(this.clientConfig, `Live Code Runner ${pkgVersion}; VSCode ${vscode.version}`);
        }
    }
        ...
        if (grammar) {
            ...
            switch (grammarName) {
                ...
                case "r":
                    ...
                    break;
                case "julia":
                    kernelName = "julia:latest";
                    break;
                case "lua":
                    kernelName = "lua:latest";
                    break;
                case "php":
                    kernelName = "php:latest";
                    break;
                case "haskell":
                    kernelName = "haskell:latest";
                    break;
                case "matlab":
                case "octave":
                    kernelName = "octave:latest";
                    break;
                case "nodejs":
                case "javascript":
                    kernelName = "nodejs:latest";
                    break;
...
exports.LiveCodeRunner = LiveCodeRunner;
//# sourceMappingURL=live-code-runner.js.map