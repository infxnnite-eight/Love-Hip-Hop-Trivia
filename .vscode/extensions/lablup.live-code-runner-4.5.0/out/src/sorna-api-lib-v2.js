...
class SornaAPILib {
    ...
    getAPIversion() {
        ...
        return node_fetch_1.default(this.baseURL + '/' + this.apiVersionMajor, requestInfo)
    ...
    createKernel(kernelType) {
        ...
        return node_fetch_1.default(this.baseURL + '/' + this.apiVersionMajor + '/kernel/create', requestInfo);
    }
    destroyKernel(kernelId) {
        let requestInfo = this.newRequest('DELETE', `/v2/kernel/${kernelId}`, null);
        return node_fetch_1.default(this.baseURL + '/' + this.apiVersionMajor + '/kernel/' + kernelId, requestInfo);
    }
...
exports.default = SornaAPILib;
module.exports.SornaAPILib = SornaAPILib;
//# sourceMappingURL=sorna-api-lib-v2.js.map