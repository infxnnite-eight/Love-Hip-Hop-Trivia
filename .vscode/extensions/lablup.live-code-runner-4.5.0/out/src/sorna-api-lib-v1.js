...
class SornaAPILib {
    ...
    getAPIversion() {
        ...
        return node_fetch_1.default(this.baseURL + '/v1', requestInfo)
    ...
    createKernel(kernelType) {
        ...
        return node_fetch_1.default(this.baseURL + '/v1/kernel/create', requestInfo);
    }
    destroyKernel(kernelId) {
        let requestInfo = this.newRequest('DELETE', `/v1/kernel/${kernelId}`, null);
        return node_fetch_1.default(this.baseURL + '/v1/kernel/' + kernelId, requestInfo);
    }
...
//# sourceMappingURL=sorna-api-lib-v1.js.map